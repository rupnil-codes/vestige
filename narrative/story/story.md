...
> My idea is to let the player count silhouettes setting the stage for further development.
> 
> Pacing goal: ~3 mins

The progression would be like:
1. Game opens with the protagonist sitting in a bench at the middle of the woods (with a cabin with lights in sight).
...
**Aim:** The aim of this chapter is to answer the question: "What?". 
This chapter would make the player aware of the situation about "what" happened i.e.,
_A group of hikers died in the middle of the dense forest mysteriously. But somehow I (the player) seem connected_
So naturally the next questions would be "Who did it?" and "Why?". I wanna end chapter 1 on that note.

> I am going to keep the scope small for the first chapter
> Targeting about ~20 minutes gameplay.
> 
> Pacing goal: 
> - ~5 mins: Setup and hiking
> - ~10 mins: Exploration-- Campsite, trails, clues
> - ~5 mins: Cabin scene and finale
...
5. Finds the vestige (remnants) of an abandoned campsite; Finds some leads like a map, journal, camera.
...
9. Ultimately reaches a log cabin, hand built but old. There is a rusted lock at the door.
10. Log cabin seems familiar. Sees ONLY ONE skeleton sitting on a chair, with notes.
11. Long hallway
...
Chapter 1 stays very, very mysterious and eerie, the player ends the game in a confused and a feeling of vulnerability.
I don't want to explain everything, there will be hints but nothing is force-fed to the player.
It will be an open-ended chapter.
